					...
					<div class="user-info">
						...
						<div class="user-image">
							<a href="extra-profile.html">
								<img src="{{ asset('images/user/user-4.png') }}" class="img-responsive img-circle" />
							</a>
						</div>
						...
						<div class="user-details">
							...
							<p class="user-title">Marketing Head - Lodha Group </p>
